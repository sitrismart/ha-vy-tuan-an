  ...
  return (
    <section className="relative w-full py-10 px-4 overflow-hidden">
      ...
      <div className="relative w-full max-w-[340px] mx-auto min-h-[460px] py-4">
        ...
        >
          <path
            d="M 170 30 C 270 90, 280 140, 170 180 C 60 220, 50 280, 170 330 C 260 370, 240 420, 170 450"
            stroke="#7A121D"
            strokeWidth="1.5"
            strokeDasharray="4 4"
            opacity="0.6"
        ...
        >
          ...
          <p className="text-[11px] text-[#6A4D53] max-w-[200px] mt-0.5">
            Lễ vu quy trang trọng tại tư gia
          </p>
        ...
        >
          <div className="flex flex-col items-center">
            ...
            <p className="text-[11px] text-[#6A4D53] max-w-[180px] mt-0.5">
              Trao nhẫn & lời hẹn ước trăm năm
            </p>
            {/* Wedding Rings SVG Icon */}
            <div className="mt-2 w-10 h-10 rounded-full bg-white border border-[#7A121D]/30 flex items-center justify-center text-[#7A121D] shadow-sm">
        ...
        >
          <div className="flex flex-col items-center">
            ...
            <p className="text-[11px] text-[#6A4D53] max-w-[180px] mt-0.5">
              Chúc rượu & thưởng thức tiệc cưới
            </p>
            {/* Dinner Fork & Knife SVG */}
            <div className="mt-2 w-10 h-10 rounded-full bg-white border border-[#7A121D]/30 flex items-center justify-center text-[#7A121D] shadow-sm">
              <svg viewBox="0 0 24 24" className="w-5 h-5 fill-none stroke-current" strokeWidth="1.5">
        ...
        >
          ...
          <p className="text-[11px] text-[#6A4D53] max-w-[200px] mt-0.5">
            Minigame vui nhộn & khiêu vũ chúc phúc
          </p>
          {/* Music Note SVG Icon */}
          <div className="mt-2 w-10 h-10 rounded-full bg-white border border-[#7A121D]/30 flex items-center justify-center text-[#7A121D] shadow-sm">
            <svg viewBox="0 0 24 24" className="w-5 h-5 fill-none stroke-current" strokeWidth="1.5">
